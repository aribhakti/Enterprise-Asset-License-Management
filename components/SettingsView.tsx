  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
      ...
      <div className="w-full lg:w-64 shrink-0 overflow-x-auto lg:overflow-visible">
        <div className="flex lg:flex-col gap-2 bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-100 dark:border-slate-800 p-2 shadow-sm lg:sticky lg:top-4 min-w-max">
          {tabs.map(tab => (
            <button
              key={tab.id}
              onClick={() => setActiveTab(tab.id)}
              className={`flex items-center justify-between px-4 py-3.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap ${
                activeTab === tab.id 
            ...
            >
              ...
              {activeTab === tab.id && <ChevronRight className="w-3 h-3 hidden lg:block" />}
            </button>
          ))}
        </div>
      </div>
...
const BrandSettings = ({ config, onChange }: { config: DashboardConfig, onChange: (c: DashboardConfig) => void }) => {
  return (
    <div className="p-8 space-y-8">
      <div className="border-b border-slate-50 dark:border-slate-800 pb-6 mb-6">
        <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase">Brand Settings</h3>
        <p className="text-xs text-slate-400 font-bold uppercase tracking-widest">Customize the look and feel</p>
      </div>

      <div className="grid md:grid-cols-2 gap-8">
        <div className="space-y-4">
          <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Logo Dark</label>
          <div className="border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-2xl p-6 flex flex-col items-center justify-center text-center hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors cursor-pointer group">
            <div className="w-32 h-12 bg-slate-900 rounded-lg flex items-center justify-center mb-3 border border-slate-700">
               <span className="text-white font-black italic">LOGO</span>
            </div>
            <span className="text-[9px] font-black uppercase text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/30 px-3 py-1.5 rounded-lg group-hover:bg-indigo-600 group-hover:text-white transition-all flex items-center gap-2">
      ...
      <div className="grid md:grid-cols-2 gap-8">
         ...
         <div className="flex items-center justify-between bg-slate-50 dark:bg-slate-800 p-4 rounded-xl border border-slate-100 dark:border-slate-700">
            <div>
                <p className="text-[10px] font-black text-slate-900 dark:text-white uppercase tracking-widest">Enable RTL</p>
      ...
      <div className="space-y-4">
         <h4 className="text-xs font-black text-slate-900 dark:text-white uppercase tracking-widest">Theme Customizer</h4>
         <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-slate-50 dark:bg-slate-800 p-4 rounded-xl border border-slate-100 dark:border-slate-700">
               ...
               <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-slate-700 dark:text-slate-300">Transparent</span>
            ...
            <div className="bg-slate-50 dark:bg-slate-800 p-4 rounded-xl border border-slate-100 dark:border-slate-700">
               ...
               <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-slate-700 dark:text-slate-300">{config.darkMode ? 'Dark Mode' : 'Light Mode'}</span>
...
const SystemSettings = ({ config, onChange }: { config: DashboardConfig, onChange: (c: DashboardConfig) => void }) => {
   return (
    <div className="p-8 space-y-8">
      <div className="border-b border-slate-50 dark:border-slate-800 pb-6 mb-6">
        <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase">System Settings</h3>
      ...
      <div className="flex items-center justify-between bg-slate-50 dark:bg-slate-800 p-4 rounded-xl border border-slate-100 dark:border-slate-700">
          <div>
              <p className="text-[10px] font-black text-slate-900 dark:text-white uppercase tracking-widest">Display Shipping</p>
      ...
      <div className="space-y-4">
         ...
         <textarea 
            ...
            className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl p-4 min-h-[120px] text-xs font-bold text-slate-600 dark:text-slate-300 focus:outline-none focus:ring-2 focus:ring-indigo-500/10"
         />
      </div>
    </div>
   );
...
const GovernanceSettings = ({ config, onChange }: { config: DashboardConfig, onChange: (c: DashboardConfig) => void }) => {
   ...
   return (
      <div className="p-8 space-y-8">
         <div className="border-b border-slate-50 dark:border-slate-800 pb-6 mb-6">
            <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase">Governance & Security</h3>
         ...
         <div className="bg-slate-50 dark:bg-slate-800 p-6 rounded-2xl border border-slate-100 dark:border-slate-700 transition-all">
            <div className="flex justify-between items-center mb-6">
               <div className="flex items-start gap-4">
                  ...
                  <div>
                     <h4 className="text-xs font-black text-slate-900 dark:text-white uppercase tracking-wide">Checker-Maker Protocol</h4>
            ...
            {config.enableCheckerMaker && (
               <div className="pt-6 border-t border-slate-200 dark:border-slate-700 animate-in slide-in-from-top-2 duration-300 space-y-6">
                  ...
                  <div>
                     ...
                     <div className="grid grid-cols-2 gap-4">
                        {[
                           ...
                           <div key={action.id} onClick={() => toggleAction(action.id)} className={`p-3 rounded-xl border cursor-pointer flex items-center gap-3 transition-all ${config.checkerActions?.includes(action.id) ? 'bg-indigo-50 dark:bg-indigo-900/20 border-indigo-200 dark:border-indigo-800' : 'bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800'}`}>
                              <div className={`w-4 h-4 rounded border flex items-center justify-center ${config.checkerActions?.includes(action.id) ? 'bg-indigo-600 border-indigo-600' : 'border-slate-300 dark:border-slate-600'}`}>
         ...
         <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 flex flex-col justify-between">
               <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                     <h4 className="text-xs font-black text-slate-900 dark:text-white uppercase tracking-wide">IP Restriction</h4>
            ...
            <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 flex flex-col justify-between">
               <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                     <h4 className="text-xs font-black text-slate-900 dark:text-white uppercase tracking-wide">Audit Logging</h4>
...
const CompanySettings = ({ config, onChange }: { config: DashboardConfig, onChange: (c: DashboardConfig) => void }) => {
   return (
    <div className="p-8 space-y-8">
      <div className="border-b border-slate-50 dark:border-slate-800 pb-6 mb-6">
        <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase">Company Settings</h3>
      ...
      <div className="grid md:grid-cols-3 gap-6">
         ...
         <div className="flex items-center justify-between bg-slate-50 dark:bg-slate-800 p-4 rounded-xl border border-slate-100 dark:border-slate-700 h-full">
            <span className="text-[10px] font-black text-slate-900 dark:text-white uppercase tracking-widest">Tax Number</span>
...
const CurrencySettings = ({ config, onChange }: { config: DashboardConfig, onChange: (c: DashboardConfig) => void }) => {
   return (
    <div className="p-8 space-y-8">
      <div className="border-b border-slate-50 dark:border-slate-800 pb-6 mb-6">
        <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase">Currency Settings</h3>
      ...
      <div className="bg-slate-50 dark:bg-slate-800 p-6 rounded-2xl border border-slate-100 dark:border-slate-700 flex items-center gap-4">
...
const EmailSettings = ({ config, onChange }: { config: DashboardConfig, onChange: (c: DashboardConfig) => void }) => {
  return (
    <div className="p-8 space-y-8">
      <div className="border-b border-slate-50 dark:border-slate-800 pb-6 mb-6">
        <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase">Email Settings</h3>
      ...
      <div className="pt-6 border-t border-slate-100 dark:border-slate-800 flex justify-end gap-3">
         <button className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 px-6 py-3 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-slate-50 dark:hover:bg-slate-800 transition-all">Test Mail</button>
      </div>
    </div>
  );
};
...
const PaymentSettings = ({ config, onChange }: { config: DashboardConfig, onChange: (c: DashboardConfig) => void }) => {
   ...
   return (
    <div className="p-8 space-y-8">
      <div className="border-b border-slate-50 dark:border-slate-800 pb-6 mb-6">
        <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase">Payment Settings</h3>
        <p className="text-xs text-slate-400 font-bold uppercase tracking-widest">Enable payment gateways for invoice settlement</p>
      </div>

      <div className="space-y-4">
         {gateways.map((gw) => (
            <div key={gw} className="flex items-center justify-between bg-slate-50 dark:bg-slate-800 p-5 rounded-xl border border-slate-100 dark:border-slate-700 hover:border-indigo-100 dark:hover:border-indigo-900 hover:bg-white dark:hover:bg-slate-900 transition-all">
               <span className="text-xs font-black text-slate-900 dark:text-white uppercase tracking-wide">{gw}</span>
               <div className="flex items-center gap-3">
...
const ToggleSwitch = ({ isOn, onToggle }: { isOn: boolean; onToggle?: () => void }) => {
   return (
      <button 
         onClick={onToggle}
         className={`w-10 h-6 rounded-full p-1 transition-all duration-300 ${isOn ? 'bg-indigo-600' : 'bg-slate-200 dark:bg-slate-700'}`}
         type="button"
      >
